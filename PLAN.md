...
3. we will do test driven development:
4. write a test for the bug 
5. see it fails 
6. write code to make the test pass 
7. run it 
8. if it fails, change the code (not the test) to make it run again 
